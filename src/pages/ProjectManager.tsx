    ...
    <main>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
        <div className="flex items-center space-x-2 text-sm text-gray-600">
          ...
          <span>›</span>
          <a href="/courses/management" className="hover:text-gray-900">Управление</a>
          <span>›</span>
          <span className="text-gray-400">Профессия Менеджер проектов</span>
        </div>
      </div>
      ...
      <section className="bg-green-50 py-16 mb-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative">
            {/* Payment Info */}
            <div className="mb-8">
              <p className="text-lg font-semibold">ПЕРВЫЙ ПЛАТЕЖ НА 2-ОЙ МЕСЯЦ</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4 mt-8">
              ...
              <div className="bg-white rounded-lg p-4">
                <h3 className="font-bold mb-2">Воркшопы</h3>
                <p className="text-sm text-gray-600">
                  для проработки сложных тем
                </p>
              </div>

              {/* Online */}
              <div className="bg-white rounded-lg p-4">
                <h3 className="font-bold mb-2">Онлайн</h3>
                <p className="text-sm text-gray-600">
                  в удобное время
                </p>
              </div>
              ...
              {/* Case Studies */}
              <div className="bg-white rounded-lg p-4">
                <h3 className="font-bold mb-2">Разбор реальных кейсов</h3>
                <p className="text-sm text-gray-600">
                  с практиками бизнес-анализа
                </p>
              </div>
              ...
              <div className="bg-yellow-400 rounded-lg p-4">
                ...
                <div className="flex items-center text-sm">
                  ...
                  <span>Скидка действует: 06:45:34</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-8 rounded-xl shadow-sm">
                <div className="text-4xl font-bold mb-4">400 000 ₸</div>
              ...
              {/* Middle */}
              <div className="bg-white p-8 rounded-xl shadow-sm">
                <div className="text-4xl font-bold mb-4">700 000 ₸</div>
                <div className="flex justify-between text-gray-600">
                  <span>Middle</span>
                  <span>1-3 года</span>
                </div>
              ...
              <div className="bg-white p-8 rounded-xl shadow-sm relative">
                <div className="text-4xl font-bold mb-4">1 000 000 ₸</div>
                <div className="flex justify-between text-gray-600">
                  <span>Senior</span>
                  <span>3+ года</span>
                </div>
